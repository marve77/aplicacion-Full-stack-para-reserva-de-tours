...
const EditorReservations: React.FC<{ token: string | null }> = ({ token }) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
          <div className="bg-[#101828] border-2 border-cyan-400 shadow-cyan-500/40 shadow-xl w-96 flex flex-col gap-4 rounded-2xl p-8 relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-white py-2 rounded-lg font-bold border border-cyan-400 shadow-cyan-500/30 shadow-md transition-all"
              >
...
export default EditorReservations;
